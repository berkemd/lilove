...
export default function Privacy() {
  ...
  const content = legalTranslations[language].privacy;
      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 print:hidden">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold" data-testid="text-privacy-title">{content.title}</h1>
          </div>
              ...
              <CardContent className="prose prose-slate dark:prose-invert max-w-none">
                ...
                <div className="mt-12 pt-8 border-t">
                  <p className="text-sm text-muted-foreground">
                    ...
                    <a 
                      href="mailto:privacy@lilove.org" 
